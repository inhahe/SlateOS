...
fn run_satty(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("satty v0.12 (Slate OS) — Screenshot annotation tool");
        println!();
        println!("Options:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "satty".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_satty, strip_ext};
    ...
    fn help_exits_zero() {
        ...
        let _ = run_satty(&["--version".to_string()], "satty");
    }

    #[test]
    fn default_invocation_does_not_panic() {
        let _ = run_satty(&[], "satty");
    }
}
