...
//! smartsheet-cli — OurOS Smartsheet (NYSE:SMAR, spreadsheet-meets-PM)
...
fn run_ss(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Smartsheet (OurOS) — spreadsheet-meets-project-management for enterprise");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Smartsheet 2024 (OurOS)"); return 0; }
    println!("Smartsheet 2024 (OurOS)");
