...
//! sophos-cli — OurOS Sophos Home / Intercept X / Central
//!
...
fn run_sophos(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Sophos Intercept X Advanced / Central / Home (OurOS)");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Sophos Intercept X Advanced 2024.4 / Endpoint Agent 2024.4.5.5 (OurOS)"); return 0; }
    println!("Sophos Intercept X Advanced 2024.4 (OurOS)");
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_sophos(&["--version".to_string()], "sophos"), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_sophos(&[], "sophos"), 0);
    }
}
