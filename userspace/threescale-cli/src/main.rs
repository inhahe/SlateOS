...
mod tests {
    ...
    #[test]
    fn t_basename() {
        assert_eq!(basename("/usr/bin/threescale"), "threescale");
    }
    #[test]
    fn t_strip() {
        assert_eq!(strip_ext("threescale.exe"), "threescale");
    }
    #[test]
    fn t_help() {
        assert_eq!(run_threescale(&[], "threescale"), 0);
    }
    #[test]
    fn t_unknown() {
        assert_eq!(run_threescale(&["xx".to_string()], "threescale"), 2);
    }
}
