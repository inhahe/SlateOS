...
//! hashcat-cli — OurOS hashcat password recovery
//!
...
fn run_hashcat(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("hashcat v6.2 (OurOS) — Advanced password recovery");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("hashcat v6.2.6 (OurOS)"); return 0; }
    println!("hashcat v6.2.6 (OurOS)");
    println!("  OpenCL Platform: OurOS GPU Runtime");
