...
fn main() {
    ...
    let _prog = args
        ...
        .unwrap_or_else(|| "latex2html".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_latex2html, strip_ext};
    ...
    fn help_exits_zero() {
        ...
        let _ = run_latex2html(&["--version".to_string()], "latex2html");
    }

    #[test]
    fn default_invocation_does_not_panic() {
        let _ = run_latex2html(&[], "latex2html");
    }
}
