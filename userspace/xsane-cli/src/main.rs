...
fn run_xsane(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("xsane v0.999 (Slate OS) — Graphical scanner frontend");
        println!();
        println!("Options:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "xsane".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_xsane, strip_ext};
    ...
    fn help_exits_zero() {
        ...
        let _ = run_xsane(&["--version".to_string()], "xsane");
    }

    #[test]
    fn default_invocation_does_not_panic() {
        let _ = run_xsane(&[], "xsane");
    }
}
