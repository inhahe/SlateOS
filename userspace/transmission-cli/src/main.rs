...
//! transmission-cli — OurOS Transmission BitTorrent client
//!
...
fn run_daemon(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("transmission-daemon v4.0 (OurOS) — BitTorrent daemon");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("transmission-daemon v4.0 (OurOS)"); return 0; }
...
fn run_remote(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("transmission-remote v4.0 (OurOS) — Remote control client");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("transmission-remote v4.0 (OurOS)"); return 0; }
...
fn run_cli_mode(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("transmission-cli v4.0 (OurOS) — Lightweight CLI client");
        return 0;
    }
    if args.iter().any(|a| a == "--version") { println!("transmission-cli v4.0 (OurOS)"); return 0; }
...
fn run_gtk(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("transmission-gtk v4.0 (OurOS) — GTK BitTorrent client");
        return 0;
    }
    if args.iter().any(|a| a == "--version") { println!("transmission-gtk v4.0 (OurOS)"); return 0; }
