...
//! otfcc-cli — OurOS OTFCC OpenType font compiler
//!
...
fn run_otfccdump(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("otfccdump v0.10 (OurOS) — Dump OpenType font to JSON");
        println!();
        println!("Options:");
...
fn run_otfccbuild(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("otfccbuild v0.10 (OurOS) — Build OpenType font from JSON");
        println!();
        println!("Options:");
