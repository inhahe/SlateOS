...
mod tests {
    ...
    fn test_names_distinct() {
        let names = [
            ...
            CS_POSIX_V7_ILP32_OFF32_CFLAGS,
            CS_POSIX_V7_ILP32_OFF32_LDFLAGS,
            CS_POSIX_V7_ILP32_OFF32_LIBS,
            CS_POSIX_V7_ILP32_OFFBIG_CFLAGS,
            CS_POSIX_V7_ILP32_OFFBIG_LDFLAGS,
            CS_POSIX_V7_ILP32_OFFBIG_LIBS,
            CS_POSIX_V7_LP64_OFF64_CFLAGS,
            CS_POSIX_V7_LP64_OFF64_LDFLAGS,
            CS_POSIX_V7_LP64_OFF64_LIBS,
            CS_POSIX_V7_LPBIG_OFFBIG_CFLAGS,
            CS_POSIX_V7_LPBIG_OFFBIG_LDFLAGS,
