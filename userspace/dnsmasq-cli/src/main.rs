...
fn run_dnsmasq(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("dnsmasq v2.90 (Slate OS) — Lightweight DNS forwarder and DHCP server");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("dnsmasq v2.90 (Slate OS)"); return 0; }
    println!("dnsmasq v2.90 (Slate OS)");
