...
//! mvn-cli — OurOS Apache Maven build system
//!
...
fn run_mvn(args: &[String]) -> i32 {
    ...
    if args.iter().any(|a| a == "--version" || a == "-v") {
        ...
        println!("Java version: 21.0.2, vendor: OurOS");
        println!("Default locale: en_US, platform encoding: UTF-8");
        println!("OS name: \"ouros\", version: \"1.0\", arch: \"amd64\"");
        return 0;
    }
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_mvn(&["--version".to_string()]), 0);
    }
