...
//! gatk-cli — OurOS GATK Genome Analysis Toolkit
//!
...
fn run_gatk(args: &[String]) -> i32 {
    ...
    match subcmd {
        "--version" => println!("GATK 4.5.0.0 (OurOS)"),
        "HaplotypeCaller" => {
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_gatk(&["--version".to_string()]), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_gatk(&[]), 0);
    }
}
