...
fn run_mame(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("mame v0.262 (Slate OS) — Multiple Arcade Machine Emulator");
        println!();
        println!("Options:");
    ...
    println!("mame: loading system {}...", quoteaf_os(system));
    0
}
...
#[cfg(test)]
mod tests {
    use super::{basename, run_mame, strip_ext};
    ...
    fn help_exits_zero() {
        ...
        let _ = run_mame(&["--version".to_string()], "mame");
    }
