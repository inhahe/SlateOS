...
//! ngspice-cli — OurOS ngspice circuit simulator
//!
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_ngspice(&["--version".to_string()]), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_ngspice(&[]), 0);
    }
}
