...
//! wl-protocols-cli — OurOS Wayland protocol info tool
//!
...
fn run_wl_protocols(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("wl-protocols v1.36 (OurOS) — Wayland protocol information");
        println!();
        println!("Commands:");
    ...
    match cmd {
        ...
        "version" => println!("wayland-protocols v1.36 (OurOS)"),
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_wl_protocols(&["--version".to_string()], "wl-protocols"), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_wl_protocols(&[], "wl-protocols"), 0);
    }
}
