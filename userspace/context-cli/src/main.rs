...
fn run_context(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("ConTeXt LMTX (Slate OS) — Document engineering system");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("ConTeXt LMTX 2024.04 (Slate OS)"); return 0; }
    println!("ConTeXt LMTX 2024.04 (Slate OS)");
