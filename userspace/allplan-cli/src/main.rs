...
fn run_allplan(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Nemetschek Allplan 2025 (Slate OS) — BIM for architecture/engineering");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Nemetschek Allplan 2025-1 (Slate OS)"); return 0; }
    println!("Nemetschek Allplan 2025-1 (Slate OS)");
