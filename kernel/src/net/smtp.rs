...
pub fn self_test() -> KernelResult<()> {
    ...
    let _pristine_messages_sent = crate::fs::selftest::pristine_atomic(&MESSAGES_SENT, 0);
    let _pristine_messages_failed = crate::fs::selftest::pristine_atomic(&MESSAGES_FAILED, 0);
