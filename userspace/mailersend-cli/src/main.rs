...
mod tests {
    ...
    #[test]
    fn t_basename() {
        assert_eq!(basename("/usr/bin/mailersend"), "mailersend");
    }
    #[test]
    fn t_strip() {
        assert_eq!(strip_ext("mailersend.exe"), "mailersend");
    }
    #[test]
    fn t_help() {
        assert_eq!(run_mailersend(&[], "mailersend"), 0);
    }
    #[test]
    fn t_unknown() {
        assert_eq!(run_mailersend(&["xx".to_string()], "mailersend"), 2);
    }
}
