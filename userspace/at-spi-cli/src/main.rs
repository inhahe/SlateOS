...
//! at-spi-cli — Slate OS AT-SPI2 accessibility tools CLI
//!
...
fn run_registryd(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!();
        println!("AT-SPI2 registry daemon (Slate OS).");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") {
        println!("at-spi2-registryd 2.52.0 (Slate OS)");
        return 0;
    }
...
fn run_bus_launcher(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!();
        println!("AT-SPI accessibility bus launcher (Slate OS).");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") {
        println!("at-spi-bus-launcher 2.52.0 (Slate OS)");
        return 0;
    }
...
fn run_accerciser(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!();
        println!("Accerciser — interactive accessibility explorer (Slate OS).");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") {
        println!("Accerciser 3.42.0 (Slate OS)");
        return 0;
    }
