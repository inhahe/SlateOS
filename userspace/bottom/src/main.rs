...
//! bottom — OurOS graphical system/process monitor (btm)
//!
...
fn run_btm(args: Vec<String>) -> i32 {
    ...
    if basic {
        ...
        println!("btm 0.10.2 (OurOS) — TUI launched");
        println!();
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_btm(vec!["--version".to_string()]), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_btm(vec![]), 0);
    }
}
