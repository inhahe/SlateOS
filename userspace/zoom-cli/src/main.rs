...
fn run_zoom(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("zoom v5.17 (Slate OS) — Video conferencing client");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("zoom v5.17 (Slate OS)"); return 0; }
...
mod tests {
    ...
    fn help_exits_zero() {
        ...
        let _ = run_zoom(&["--version".to_string()], "zoom");
    }
