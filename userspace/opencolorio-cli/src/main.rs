...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "ociocheck".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_ociocheck, strip_ext};
    ...
    fn help_exits_zero() {
        ...
        let _ = run_ociocheck(&["--version".to_string()], "opencolorio");
    }

    #[test]
    fn default_invocation_does_not_panic() {
        let _ = run_ociocheck(&[], "opencolorio");
    }
}
