"""Mutation test for the snippets suite -- and, since 2026-09-26, for the
snippet editor, the library kept on disk, and the question before a delete.
...
MUTATIONS = [
    ...
    (
        ...
        "                Ok(message) => (message, self.palette.red),",
    ...
    (
        ...
        "                Err(message) => (message, self.palette.green),",
        ["an_export_that_failed_says_so_in_red"],
    ),
    (
    ...
    # -- The editor, the kept library, the question before a delete (2026-09-26)
