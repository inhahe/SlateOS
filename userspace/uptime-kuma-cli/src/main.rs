...
//! uptime-kuma-cli — OurOS Uptime Kuma monitoring
//!
...
fn run_uptime_kuma(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Uptime Kuma v1.23 (OurOS) — Self-hosted monitoring tool");
        println!();
        println!("Commands:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Uptime Kuma v1.23.13 (OurOS)"); return 0; }
    println!("Uptime Kuma v1.23.13 (OurOS)");
