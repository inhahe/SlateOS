...
fn run_salmon(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("Salmon v1.10 (Slate OS) — Fast transcript quantification");
        println!();
        println!("Commands:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "salmon".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_salmon, strip_ext};
