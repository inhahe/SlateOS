...
//! wrike-cli — OurOS Wrike (Citrix-owned enterprise work management)
...
fn run_wrike(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Wrike (OurOS) — enterprise collaborative work management (Citrix-owned)");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Wrike 2024 (OurOS)"); return 0; }
    println!("Wrike 2024 (OurOS)");
