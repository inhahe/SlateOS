...
pub fn self_test() -> KernelResult<()> {
    let _pristine_tcp_connects = crate::fs::selftest::pristine_atomic(&TCP_CONNECTS, 0);
    let _pristine_tcp_listens = crate::fs::selftest::pristine_atomic(&TCP_LISTENS, 0);
    let _pristine_udp_sends = crate::fs::selftest::pristine_atomic(&UDP_SENDS, 0);
    let _pristine_port_scans = crate::fs::selftest::pristine_atomic(&PORT_SCANS, 0);
