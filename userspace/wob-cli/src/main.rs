...
fn run_wob(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("wob v0.15 (Slate OS) — Wayland overlay bar (volume/brightness)");
        println!();
...
#[cfg(test)]
mod tests {
    use super::{basename, run_wob, strip_ext};
    ...
    fn help_exits_zero() {
        ...
        let _ = run_wob(&["--version".to_string()], "wob");
    }
