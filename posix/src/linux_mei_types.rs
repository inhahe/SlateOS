...
pub const MEI_UUID_AMT: [u8; 16] = [
    0x12, 0xF8, 0x02, 0x28, 0x61, 0xD2, 0x11, 0xDD,
...
pub const MEI_UUID_BUS_ENUM: [u8; 16] = [
    0xBB, 0x8F, 0xDC, 0x6F, 0x5C, 0xAA, 0x49, 0x21,
    0x80, 0x12, 0x00, 0x38, 0x5A, 0x49, 0x86, 0x03,
];
...
mod tests {
    ...
    fn test_states_distinct() {
        let states = [
            MEI_CL_STATE_IDLE, MEI_CL_STATE_CONNECTING,
            MEI_CL_STATE_CONNECTED, MEI_CL_STATE_DISCONNECTING,
        ];
