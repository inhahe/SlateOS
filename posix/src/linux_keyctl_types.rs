...
mod tests {
    ...
    fn test_keyctl_ops_distinct() {
        let ops = [
            ...
            KEYCTL_GET_SECURITY, KEYCTL_SESSION_TO_PARENT,
            KEYCTL_REJECT, KEYCTL_INSTANTIATE_IOV,
            KEYCTL_INVALIDATE, KEYCTL_GET_PERSISTENT,
            KEYCTL_DH_COMPUTE, KEYCTL_RESTRICT_KEYRING,
        ];
        for i in 0..ops.len() {
    ...
    fn test_usr_all_covers_all_usr() {
        let combined = KEY_USR_VIEW | KEY_USR_READ | KEY_USR_WRITE
