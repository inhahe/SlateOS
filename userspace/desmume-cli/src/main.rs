...
//! desmume-cli — OurOS DeSmuME Nintendo DS emulator
//!
...
fn run_desmume(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("DeSmuME v0.9.13 (OurOS) — Nintendo DS emulator");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("DeSmuME v0.9.13 (OurOS)"); return 0; }
