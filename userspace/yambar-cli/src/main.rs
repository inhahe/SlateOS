...
fn run_yambar(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("yambar v1.10 (Slate OS) — Modular Wayland status bar");
        println!();
        println!("Options:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "yambar".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_yambar, strip_ext};
