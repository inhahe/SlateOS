...
//! matlab-cli — OurOS MathWorks MATLAB technical computing
//!
...
fn run_matlab(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("MathWorks MATLAB R2024b (OurOS) — Numerical computing environment");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("MathWorks MATLAB 9.17.0.2403282 (R2024b) (OurOS)"); return 0; }
    println!("MathWorks MATLAB R2024b (OurOS)");
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_matlab(&["--version".to_string()], "matlab"), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_matlab(&[], "matlab"), 0);
    }
}
