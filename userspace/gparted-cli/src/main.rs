...
fn run_gparted(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("gparted v1.6 (Slate OS) — GNOME Partition Editor");
        println!();
        println!("Options:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "gparted".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_gparted, strip_ext};
    ...
    fn help_exits_zero() {
        ...
        let _ = run_gparted(&["--version".to_string()], "gparted");
    }

    #[test]
    fn default_invocation_does_not_panic() {
        let _ = run_gparted(&[], "gparted");
    }
}
