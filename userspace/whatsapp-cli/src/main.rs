...
//! whatsapp-cli — OurOS Meta WhatsApp messaging
//!
...
fn run_wa(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("WhatsApp Messenger (OurOS) — Meta's end-to-end encrypted messenger");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("WhatsApp Desktop 2.2448.7.0 (OurOS)"); return 0; }
    println!("WhatsApp Desktop 2.2448.7.0 (OurOS)");
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_wa(&["--version".to_string()], "whatsapp"), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_wa(&[], "whatsapp"), 0);
    }
}
