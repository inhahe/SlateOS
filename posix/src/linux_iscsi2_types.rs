...
mod tests {
    ...
    fn test_uevent_types_distinct() {
        let events = [
            ISCSI_UEVENT_CREATE_SESSION, ISCSI_UEVENT_DESTROY_SESSION,
            ISCSI_UEVENT_CREATE_CONN, ISCSI_UEVENT_DESTROY_CONN,
            ISCSI_UEVENT_BIND_CONN, ISCSI_UEVENT_START_CONN,
            ISCSI_UEVENT_STOP_CONN, ISCSI_UEVENT_SEND_PDU,
            ISCSI_UEVENT_SET_HOST_PARAM, ISCSI_UEVENT_SET_IFACE_PARAMS,
            ISCSI_UEVENT_GET_STATS, ISCSI_UEVENT_SET_PARAM,
    ...
    fn test_conn_states_distinct() {
        let states = [
            ISCSI_CONN_LOGIN, ISCSI_CONN_LOGGED_IN,
            ISCSI_CONN_CLEANUP_WAIT, ISCSI_CONN_STARTED,
            ISCSI_CONN_STOPPED, ISCSI_CONN_FAILED,
        ];
        for i in 0..states.len() {
            for j in (i + 1)..states.len() {
                assert_ne!(states[i], states[j]);
    ...
    fn test_params_distinct() {
        let params = [
            ISCSI_PARAM_MAX_RECV_DLENGTH, ISCSI_PARAM_MAX_XMIT_DLENGTH,
            ISCSI_PARAM_HDRDGST_EN, ISCSI_PARAM_DATADGST_EN,
            ISCSI_PARAM_INITIAL_R2T_EN, ISCSI_PARAM_MAX_R2T,
            ISCSI_PARAM_IMM_DATA_EN, ISCSI_PARAM_FIRST_BURST,
            ISCSI_PARAM_MAX_BURST, ISCSI_PARAM_PDU_INORDER_EN,
            ISCSI_PARAM_DATASEQ_INORDER_EN,
            ISCSI_PARAM_DEF_TIME2WAIT, ISCSI_PARAM_DEF_TIME2RETAIN,
        ];
    ...
    fn test_error_codes_distinct() {
        let errs = [
            ISCSI_OK, ISCSI_ERR_DATASN, ISCSI_ERR_DATA_OFFSET,
            ISCSI_ERR_MAX_CMDS, ISCSI_ERR_CONN_FAILED,
        ];
        for i in 0..errs.len() {
