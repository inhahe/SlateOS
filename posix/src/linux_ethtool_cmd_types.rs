...
mod tests {
    ...
    fn test_cmds_distinct() {
        let cmds = [
            ...
            ETHTOOL_GLINK, ETHTOOL_GMSGLVL, ETHTOOL_SMSGLVL,
            ETHTOOL_GRINGPARAM, ETHTOOL_SRINGPARAM,
            ETHTOOL_GCOALESCE, ETHTOOL_SCOALESCE,
            ETHTOOL_GPAUSEPARAM, ETHTOOL_SPAUSEPARAM,
            ETHTOOL_GRXCSUM, ETHTOOL_GTXCSUM,
            ETHTOOL_TEST, ETHTOOL_GSTRINGS, ETHTOOL_GSTATS,
            ETHTOOL_GTSO, ETHTOOL_STSO,
            ETHTOOL_GGRO, ETHTOOL_GFEATURES, ETHTOOL_SFEATURES,
            ETHTOOL_GCHANNELS, ETHTOOL_SCHANNELS,
        ];
        for i in 0..cmds.len() {
