...
//! xsensors-cli — OurOS xsensors graphical sensor viewer
//!
...
fn run_xsensors(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("xsensors v0.8 (OurOS) — Graphical hardware sensor display");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("xsensors v0.8 (OurOS)"); return 0; }
