...
fn run_pcb_rnd(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("pcb-rnd v4.1 (Slate OS) — Modular PCB layout editor");
        println!();
        println!("Options:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "pcb-rnd".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_pcb_rnd, strip_ext};
