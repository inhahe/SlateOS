...
//! delta — OurOS syntax-highlighting pager for git, diff, and grep output
//!
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_delta(vec!["--version".to_string()]), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_delta(vec![]), 0);
    }
}
