...
fn run_activemq(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Apache ActiveMQ v5.18 (Slate OS) — Message broker");
        println!();
        println!("Commands:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Apache ActiveMQ v5.18.4 (Slate OS)"); return 0; }
    println!("Apache ActiveMQ v5.18.4 (Slate OS)");
