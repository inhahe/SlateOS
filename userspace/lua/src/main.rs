...
//! lua — OurOS Lua scripting language
//!
...
fn run_lua(args: Vec<String>) -> i32 {
    ...
    if args.iter().any(|a| a == "-v") {
        println!("Lua 5.4.7 (OurOS)  Copyright (C) 1994-2025 Lua.org, PUC-Rio");
        return 0;
    }
...
fn run_luarocks(args: Vec<String>) -> i32 {
    ...
    match cmd {
        "--version" => println!("luarocks 3.11.1 (OurOS)"),
        "list" => {
