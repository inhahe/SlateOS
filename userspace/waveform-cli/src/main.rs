...
//! waveform-cli — OurOS Tracktion Waveform DAW
//!
...
fn run_wf(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Tracktion Waveform Pro 13 (OurOS) — Unlimited-track single-screen DAW");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Tracktion Waveform Pro 13.0.41 (OurOS)"); return 0; }
    println!("Tracktion Waveform Pro 13.0.41 (OurOS)");
