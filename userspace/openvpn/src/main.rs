...
fn run_openvpn(args: Vec<String>) -> i32 {
    ...
    if args.iter().any(|a| a == "--version") {
        println!("OpenVPN 2.6.10 (OurOS) x86_64 [SSL (OpenSSL)] [LZO] [LZ4] [EPOLL] [MH/PKTINFO] [AEAD]");
    ...
    println!("2025-05-22 10:00:00 OpenVPN 2.6.10 (OurOS) x86_64");
