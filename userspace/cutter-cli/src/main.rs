...
fn run_cutter(args: &[String], _prog: &str) -> i32 {
    ...
    if args.iter().any(|a| a == "--version") {
        println!("Cutter v2.3.4 (Slate OS) (Rizin v0.7.2)");
        return 0;
    }
...
fn main() {
    ...
    let _prog = args
        ...
        .unwrap_or_else(|| "cutter".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_cutter, strip_ext};
    ...
    fn help_exits_zero() {
        ...
        let _ = run_cutter(&["--version".to_string()], "cutter");
    }

    #[test]
    fn default_invocation_does_not_panic() {
        let _ = run_cutter(&[], "cutter");
    }
}
