...
//! includes both the real `cryptsetup.exe` binary and the unit-test harness exe
//! that Cargo names `cryptsetup-<hash>.exe`. Without a manifest declaring
...
fn main() {
    ...
    embed_manifest::embed_manifest(embed_manifest::new_manifest("SlateOS.cryptsetup"))
