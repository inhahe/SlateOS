...
fn run_abiword(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("abiword v3.0 (Slate OS) — Lightweight word processor");
        println!();
        println!("Options:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "abiword".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_abiword, strip_ext};
