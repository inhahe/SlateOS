...
fn run_watermill(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Watermill v1.3 (Slate OS) — Event-driven processing toolkit");
        println!();
        println!("Commands:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Watermill v1.3.7 (Slate OS)"); return 0; }
    println!("Watermill v1.3.7 (Slate OS)");
