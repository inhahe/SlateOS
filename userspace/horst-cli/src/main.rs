...
fn run_horst(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("horst v5.1 (Slate OS) — Highly Optimized Radio Scanning Tool");
        println!();
        println!("Options:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "horst".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_horst, strip_ext};
