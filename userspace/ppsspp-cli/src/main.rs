...
//! ppsspp-cli — OurOS PPSSPP PSP emulator
//!
...
fn run_ppsspp(args: &[String], prog: &str) -> i32 {
    ...
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("ppsspp v1.17.1 (OurOS) — PlayStation Portable emulator");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("ppsspp v1.17.1 (OurOS)"); return 0; }
    if headless {
