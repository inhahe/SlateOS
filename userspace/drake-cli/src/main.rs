...
fn run_drake(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("Drake v1.28 (Slate OS) — Model-based robotics toolbox");
        println!();
        println!("Commands:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "drake".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_drake, strip_ext};
