...
fn run_silhouette(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Boris FX Silhouette 2024 (Slate OS) — Rotoscoping, paint, VFX node compositor");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Boris FX Silhouette 2024.0.0 (Slate OS)"); return 0; }
    println!("Boris FX Silhouette 2024.0.0 (Slate OS)");
