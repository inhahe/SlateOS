...
fn run_lp(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!();
        println!("lp — print files (Slate OS).");
        println!();
        println!("Options:");
...
fn run_lpr(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!();
        println!("lpr — print files (BSD style) (Slate OS).");
        println!();
        println!("Options:");
...
fn run_lpq(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!();
        println!("lpq — show print queue (Slate OS).");
        return 0;
    }
...
fn run_lprm(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!();
        println!("lprm — cancel print jobs (Slate OS).");
        return 0;
    }
...
fn run_lpstat(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!();
        println!("lpstat — print system status (Slate OS).");
        println!();
        println!("Options:");
...
fn run_lpadmin(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!();
        println!("lpadmin — configure CUPS printers (Slate OS).");
        println!();
        println!("Options:");
...
fn run_lpoptions(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!();
        println!("lpoptions — display/set printer options (Slate OS).");
        println!();
        println!("Options:");
        println!("  -d PRINTER     Set default printer");
...
mod tests {
    ...
    fn help_exits_zero() {
        ...
        let _ = run_lp(&["--version".to_string()]);
    }
