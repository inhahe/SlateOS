...
//! livechat-cli — OurOS LiveChat (Polish-listed pure-play live chat platform)
//!
...
fn run_livechat(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("LiveChat (OurOS) — pure-play live chat from Wroclaw, Poland");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("LiveChat 2024 (OurOS)"); return 0; }
    println!("LiveChat 2024 (OurOS)");
