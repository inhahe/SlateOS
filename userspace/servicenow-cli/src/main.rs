...
fn run_snow(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("ServiceNow Now Platform — Xanadu (Slate OS) — IT/HR/CS workflow platform");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("ServiceNow Now Platform Xanadu (Q3 2024) (Slate OS)"); return 0; }
    println!("ServiceNow Now Platform Xanadu (Q3 2024) (Slate OS)");
