...
//! freshsales-cli — OurOS Freshsales (Freshworks CRM with built-in Freddy AI)
//!
...
fn run_freshsales(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Freshsales (OurOS) — Freshworks AI-powered CRM");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Freshsales 2024 (OurOS)"); return 0; }
    println!("Freshsales 2024 (OurOS)");
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_freshsales(&["--version".to_string()], "freshsales"), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_freshsales(&[], "freshsales"), 0);
    }
}
