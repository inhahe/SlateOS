...
//! pipx-cli — OurOS pipx tool for installing Python apps in isolated envs
//!
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_pipx(&["--version".to_string()]), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_pipx(&[]), 0);
    }
}
