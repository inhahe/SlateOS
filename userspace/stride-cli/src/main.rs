...
fn run_stride(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Stride v4.2 (Slate OS) — Open-source C# 3D game engine");
        println!();
        println!("Commands:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Stride v4.2.0 (Slate OS)"); return 0; }
    println!("Stride v4.2.0 (Slate OS)");
