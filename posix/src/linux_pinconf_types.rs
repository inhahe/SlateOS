...
mod tests {
    ...
    fn test_configs_distinct() {
        let configs = [
            ...
            PIN_CONFIG_BIAS_DISABLE, PIN_CONFIG_BIAS_BUS_HOLD,
            PIN_CONFIG_BIAS_HIGH_IMPEDANCE,
            PIN_CONFIG_DRIVE_PUSH_PULL, PIN_CONFIG_DRIVE_OPEN_DRAIN,
            PIN_CONFIG_DRIVE_OPEN_SOURCE, PIN_CONFIG_DRIVE_STRENGTH,
            PIN_CONFIG_DRIVE_STRENGTH_UA,
            PIN_CONFIG_INPUT_ENABLE, PIN_CONFIG_INPUT_DEBOUNCE,
            PIN_CONFIG_INPUT_SCHMITT_ENABLE, PIN_CONFIG_INPUT_SCHMITT,
            PIN_CONFIG_LOW_POWER_MODE,
            PIN_CONFIG_OUTPUT_ENABLE, PIN_CONFIG_OUTPUT,
            PIN_CONFIG_POWER_SOURCE, PIN_CONFIG_SLEEP_HARDWARE_STATE,
            PIN_CONFIG_SLEW_RATE, PIN_CONFIG_SKEW_DELAY,
