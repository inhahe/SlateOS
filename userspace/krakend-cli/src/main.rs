...
mod tests {
    ...
    #[test]
    fn t_basename() {
        assert_eq!(basename("/usr/bin/krakend"), "krakend");
    }
    #[test]
    fn t_strip() {
        assert_eq!(strip_ext("krakend.exe"), "krakend");
    }
    #[test]
    fn t_help() {
        assert_eq!(run_krakend(&[], "krakend"), 0);
    }
    #[test]
    fn t_unknown() {
        assert_eq!(run_krakend(&["xx".to_string()], "krakend"), 2);
    }
}
