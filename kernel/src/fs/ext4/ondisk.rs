...
pub const SUPPORTED_INCOMPAT: u32 = incompat::FILETYPE
    | incompat::EXTENTS
    | incompat::BIT64
    | incompat::FLEX_BG
...
pub const SUPPORTED_RO_COMPAT: u32 = ro_compat::SPARSE_SUPER
...
fn test_superblock_field_offsets() -> crate::error::KernelResult<()> {
    ...
    let checks: &[(&str, usize, usize)] = &[
        (
            "s_inodes_count",
            field_offset!(Ext4Superblock, s_inodes_count),
            0x00,
        ),
        (
            "s_blocks_count_lo",
            field_offset!(Ext4Superblock, s_blocks_count_lo),
            0x04,
        ),
        (
            "s_free_blocks_count_lo",
            field_offset!(Ext4Superblock, s_free_blocks_count_lo),
            0x0C,
        ),
        (
            "s_free_inodes_count",
            field_offset!(Ext4Superblock, s_free_inodes_count),
            0x10,
        ),
        (
            "s_log_block_size",
            field_offset!(Ext4Superblock, s_log_block_size),
            0x18,
        ),
        (
            "s_blocks_per_group",
            field_offset!(Ext4Superblock, s_blocks_per_group),
            0x20,
        ),
        (
            "s_inodes_per_group",
            field_offset!(Ext4Superblock, s_inodes_per_group),
            0x28,
        ),
        ("s_magic", field_offset!(Ext4Superblock, s_magic), 0x38),
        (
            "s_inode_size",
            field_offset!(Ext4Superblock, s_inode_size),
            0x58,
        ),
        (
            "s_feature_compat",
            field_offset!(Ext4Superblock, s_feature_compat),
            0x5C,
        ),
        (
            "s_feature_incompat",
            field_offset!(Ext4Superblock, s_feature_incompat),
            0x60,
        ),
        (
            "s_feature_ro_compat",
            field_offset!(Ext4Superblock, s_feature_ro_compat),
            0x64,
        ),
        ("s_uuid", field_offset!(Ext4Superblock, s_uuid), 0x68),
        (
            "s_journal_inum",
            field_offset!(Ext4Superblock, s_journal_inum),
            0xE0,
        ),
        (
            "s_desc_size",
            field_offset!(Ext4Superblock, s_desc_size),
            0xFE,
        ),
        (
            "s_blocks_count_hi",
            field_offset!(Ext4Superblock, s_blocks_count_hi),
            0x150,
        ),
        (
            "s_free_blocks_count_hi",
            field_offset!(Ext4Superblock, s_free_blocks_count_hi),
            0x158,
        ),
        (
            "s_checksum",
            field_offset!(Ext4Superblock, s_checksum),
            0x3FC,
        ),
    ];
...
fn test_group_desc_field_offsets() -> crate::error::KernelResult<()> {
    ...
    let checks: &[(&str, usize, usize)] = &[
        (
            "bg_block_bitmap_lo",
            field_offset!(Ext4GroupDesc, bg_block_bitmap_lo),
            0x00,
        ),
        (
            "bg_inode_bitmap_lo",
            field_offset!(Ext4GroupDesc, bg_inode_bitmap_lo),
            0x04,
        ),
        (
            "bg_inode_table_lo",
            field_offset!(Ext4GroupDesc, bg_inode_table_lo),
            0x08,
        ),
        (
            "bg_free_blocks_count_lo",
            field_offset!(Ext4GroupDesc, bg_free_blocks_count_lo),
            0x0C,
        ),
        (
            "bg_free_inodes_count_lo",
            field_offset!(Ext4GroupDesc, bg_free_inodes_count_lo),
            0x0E,
        ),
        (
            "bg_used_dirs_count_lo",
            field_offset!(Ext4GroupDesc, bg_used_dirs_count_lo),
            0x10,
        ),
        ("bg_flags", field_offset!(Ext4GroupDesc, bg_flags), 0x12),
        (
            "bg_checksum",
            field_offset!(Ext4GroupDesc, bg_checksum),
            0x1E,
        ),
        (
            "bg_block_bitmap_hi",
            field_offset!(Ext4GroupDesc, bg_block_bitmap_hi),
            0x20,
        ),
        (
            "bg_free_blocks_count_hi",
            field_offset!(Ext4GroupDesc, bg_free_blocks_count_hi),
            0x2C,
        ),
        (
            "bg_free_inodes_count_hi",
            field_offset!(Ext4GroupDesc, bg_free_inodes_count_hi),
            0x2E,
        ),
    ];
...
fn test_inode_field_offsets() -> crate::error::KernelResult<()> {
    ...
    let checks: &[(&str, usize, usize)] = &[
        ...
        (
            "i_links_count",
            field_offset!(Ext4Inode, i_links_count),
            0x1A,
        ),
        ...
        (
            "i_file_acl_lo",
            field_offset!(Ext4Inode, i_file_acl_lo),
            0x68,
        ),
    ...
    let extra_checks: &[(&str, usize, usize)] = &[
        (
            "i_extra_isize",
            field_offset!(Ext4InodeExtra, i_extra_isize),
            0x00,
        ),
        (
            "i_checksum_hi",
            field_offset!(Ext4InodeExtra, i_checksum_hi),
            0x02,
        ),
        (
            "i_ctime_extra",
            field_offset!(Ext4InodeExtra, i_ctime_extra),
            0x04,
        ),
        ("i_crtime", field_offset!(Ext4InodeExtra, i_crtime), 0x10),
        (
            "i_crtime_extra",
            field_offset!(Ext4InodeExtra, i_crtime_extra),
            0x14,
        ),
    ];
...
fn test_extent_structures() -> crate::error::KernelResult<()> {
    ...
    if hdr.eh_magic != EXT4_EXTENT_MAGIC {
        crate::serial_println!("[ext4-ondisk]   FAIL: extent magic = {:#x}", hdr.eh_magic);
        return Err(KernelError::InternalError);
    }
