...
fn run_oha(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("oha v1.4.0 (Slate OS) — HTTP load generator with TUI");
        println!();
        println!("Options:");
...
#[cfg(test)]
mod tests {
    use super::{basename, run_oha, strip_ext};
    ...
    fn help_exits_zero() {
        ...
        let _ = run_oha(&["--version".to_string()], "oha");
    }
