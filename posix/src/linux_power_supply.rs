...
mod tests {
    ...
    fn test_health_distinct() {
        let healths = [
            ...
            POWER_SUPPLY_HEALTH_SAFETY_TIMER_EXPIRE, POWER_SUPPLY_HEALTH_OVERCURRENT,
            POWER_SUPPLY_HEALTH_CALIBRATION_REQUIRED, POWER_SUPPLY_HEALTH_WARM,
            POWER_SUPPLY_HEALTH_COOL, POWER_SUPPLY_HEALTH_HOT,
        ];
    ...
    fn test_charge_types_distinct() {
        let charges = [
            ...
            POWER_SUPPLY_CHARGE_TYPE_CUSTOM, POWER_SUPPLY_CHARGE_TYPE_LONGLIFE,
