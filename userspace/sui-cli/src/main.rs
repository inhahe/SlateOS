...
//! sui-cli — OurOS Sui Move blockchain tool
//!
...
fn run_sui(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("sui 1.25.0 (OurOS) — Sui blockchain CLI");
        println!();
        println!("Commands:");
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_sui(&["--version".to_string()], "sui"), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_sui(&[], "sui"), 0);
    }
}
