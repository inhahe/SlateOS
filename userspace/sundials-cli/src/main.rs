...
//! sundials-cli — OurOS SUNDIALS ODE/DAE solver info
//!
...
fn run_sundials(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("SUNDIALS v7.0 (OurOS) — Suite of nonlinear and differential/algebraic solvers");
        println!();
        println!("Commands:");
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_sundials(&["--version".to_string()], "sundials"), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_sundials(&[], "sundials"), 0);
    }
}
