...
//! dolphin-emu-cli — Slate OS Dolphin GameCube/Wii emulator
//!
...
fn run_dolphin(args: &[String], prog: &str) -> i32 {
    ...
    if args.iter().any(|a| a == "--version") {
        println!("dolphin-emu v5.0-21088 (Slate OS)");
        return 0;
    }
    if nogui {
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "dolphin-emu".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_dolphin, strip_ext};
