...
mod tests {
    ...
    fn basename_strips_path() {
        assert_eq!(basename("/usr/bin/duosecurity"), "duosecurity");
        assert_eq!(basename(r"C:\bin\duosecurity.exe"), "duosecurity.exe");
        assert_eq!(basename("plain"), "plain");
    }

    #[test]
    fn strip_ext_removes_extension() {
        assert_eq!(strip_ext("duosecurity.exe"), "duosecurity");
