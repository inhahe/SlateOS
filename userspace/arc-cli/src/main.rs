...
//! arc-cli — OurOS The Browser Company's Arc browser
//!
...
fn run_arc(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Arc (OurOS) — The Browser Company's reimagined-UI browser");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Arc 1.78.0 (62012) (OurOS)"); return 0; }
    println!("Arc 1.78.0 (62012) (OurOS)");
