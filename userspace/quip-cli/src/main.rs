...
//! quip-cli — OurOS Quip (Salesforce-owned docs+spreadsheets, deprecated 2025)
...
fn run_quip(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Quip (OurOS) — collaborative docs + spreadsheets + chat (Salesforce-owned, end-of-life Jan 2025)");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Quip 2024 (OurOS) — EOL Jan 2025"); return 0; }
    println!("Quip 2024 (OurOS) — END OF LIFE Jan 31 2025");
