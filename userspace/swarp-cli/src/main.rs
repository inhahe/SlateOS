...
//! swarp-cli — OurOS SWarp image resampling and co-adding
//!
...
fn run_swarp(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("SWarp v2.41 (OurOS) — Image resampling and co-addition");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("SWarp v2.41.5 (OurOS)"); return 0; }
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_swarp(&["--version".to_string()], "swarp"), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_swarp(&[], "swarp"), 0);
    }
}
