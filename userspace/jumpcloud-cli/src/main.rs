...
//! jumpcloud-cli — OurOS JumpCloud (Directory-as-a-Service — cloud AD alternative)
//!
...
fn run_jc(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("JumpCloud (OurOS) — Open Directory Platform (cloud AD replacement)");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("JumpCloud 2024 (OurOS)"); return 0; }
    println!("JumpCloud 2024 (OurOS)");
