...
//! sketchup-cli — OurOS Trimble SketchUp 3D modeling
//!
...
fn run_sketchup(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Trimble SketchUp Pro 2024 (OurOS) — 3D modeling for architecture & design");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Trimble SketchUp Pro 2024.0.484 (OurOS)"); return 0; }
    println!("Trimble SketchUp Pro 2024.0.484 (OurOS)");
