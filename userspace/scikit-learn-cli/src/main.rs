...
fn run_sklearn(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("scikit-learn v1.4 (Slate OS) — Machine learning library");
        println!();
        println!("Commands:");
    ...
    if args.iter().any(|a| a == "--version") { println!("scikit-learn v1.4.2 (Slate OS)"); return 0; }
    println!("scikit-learn v1.4.2 (Slate OS)");
...
mod tests {
    ...
    fn help_exits_zero() {
        ...
        let _ = run_sklearn(&["--version".to_string()], "scikit-learn");
    }

    #[test]
    fn default_invocation_does_not_panic() {
        let _ = run_sklearn(&[], "scikit-learn");
    }
}
