...
fn run_qucs(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("qucs v24.2 (Slate OS) — Quite Universal Circuit Simulator");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("qucs v24.2 (Slate OS)"); return 0; }
...
fn run_qucsator(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("qucsator v24.2 (Slate OS) — Qucs simulation engine");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("qucsator v24.2 (Slate OS)"); return 0; }
