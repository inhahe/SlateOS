...
//! deepin-screenshot-cli — OurOS Deepin Screenshot
//!
...
fn run_deepin_screenshot(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("deepin-screenshot v5.0 (OurOS) — Deepin screenshot tool");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("deepin-screenshot v5.0 (OurOS)"); return 0; }
