...
//! remmina-cli — Slate OS Remmina remote desktop client
//!
...
fn run_remmina(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("remmina v1.4 (Slate OS) — Remote desktop client");
        println!();
        println!("Options:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "remmina".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_remmina, strip_ext};
