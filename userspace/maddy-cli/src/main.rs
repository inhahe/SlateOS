...
fn run_maddy(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Maddy v0.7 (Slate OS) — Composable all-in-one mail server");
        println!();
        println!("Commands:");
...
fn main() {
    ...
    let _prog = args
        ...
        .unwrap_or_else(|| "maddy".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_maddy, strip_ext};
