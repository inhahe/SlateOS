...
- [ ] Search feature with checkboxes for what to search: *Checked 2026-09-16: genuinely unstarted in `apps/explorer` — no query state and no search entry point. `apps/filesearch` is a separate program and is not this.*
