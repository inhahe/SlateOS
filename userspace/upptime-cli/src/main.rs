...
//! upptime-cli — OurOS Upptime GitHub-based uptime monitor
//!
...
fn run_upptime(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Upptime v1.37 (OurOS) — GitHub-powered uptime monitor");
        println!();
        println!("Commands:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Upptime v1.37.0 (OurOS)"); return 0; }
    println!("Upptime v1.37.0 (OurOS)");
