...
fn run_magic(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Magic v8.3 (Slate OS) — Interactive VLSI layout editor");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Magic v8.3.460 (Slate OS)"); return 0; }
    println!("Magic v8.3.460 (Slate OS) — VLSI Layout Editor");
