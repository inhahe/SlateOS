...
//! swappy-cli — OurOS Swappy screenshot editor
//!
...
fn run_swappy(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("swappy v1.5 (OurOS) — Wayland screenshot editor");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("swappy v1.5 (OurOS)"); return 0; }
