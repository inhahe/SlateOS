...
//! fabric-cli — OurOS Fabric remote execution tool
//!
...
fn run_fab(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("fab v3.2 (OurOS) — Remote execution and deployment");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("fab v3.2 (OurOS, Fabric)"); return 0; }
