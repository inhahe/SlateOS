...
//! bigcommerce-cli — OurOS BigCommerce (NASDAQ:BIGC, open-platform e-commerce)
...
fn run_bc(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("BigCommerce (OurOS) — open SaaS e-commerce platform (Shopify alternative)");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("BigCommerce 2024 (OurOS)"); return 0; }
    println!("BigCommerce 2024 (OurOS)");
