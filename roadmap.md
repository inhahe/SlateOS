...
- [x] Network diagnostic tools and protocols:
  ...
  - [x] Cryptographic benchmarks: SHA-256 (64B/1KiB), SHA-512 (64B), HMAC-SHA256, ChaCha20 (1KiB), Poly1305 (1KiB), ChaCha20-Poly1305 AEAD (1KiB), X25519 key exchange, Ed25519 sign/verify; baselines in bench/baselines.toml with OpenSSL references
