...
//! whitebox-cli — OurOS WhiteboxTools geospatial analysis
//!
...
fn run_whitebox(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("WhiteboxTools v2.3 (OurOS) — Geospatial analysis platform");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("WhiteboxTools v2.3.0 (OurOS)"); return 0; }
    ...
    println!("WhiteboxTools v2.3.0 (OurOS)");
