...
//! wezterm-cli — OurOS WezTerm terminal emulator
//!
...
fn run_wezterm(args: &[String], prog: &str) -> i32 {
    ...
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("WezTerm 20240203 (OurOS) — GPU-accelerated terminal");
        println!();
        println!("Commands:");
    ...
    if args.iter().any(|a| a == "--version") {
        println!("wezterm 20240203-110809-5046fc22 (OurOS)");
        return 0;
    }
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_wezterm(&["--version".to_string()], "wezterm"), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_wezterm(&[], "wezterm"), 0);
    }
}
