...
//! notary — OurOS Notary v2 content signing
//!
...
fn run_notation(args: Vec<String>) -> i32 {
    ...
    match cmd {
        "version" => {
            println!("notation version 1.1.1 (OurOS)");
        ...
        "list" | "ls" => {
            ...
            println!("  sha256:abc123... (signed by: CN=OurOS Signer)");
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_notation(vec!["--version".to_string()]), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_notation(vec![]), 0);
    }
}
