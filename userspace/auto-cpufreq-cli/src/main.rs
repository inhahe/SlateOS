...
//! auto-cpufreq-cli — OurOS auto-cpufreq automatic CPU frequency scaler
//!
...
fn run_auto_cpufreq(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("auto-cpufreq v2.3 (OurOS) — Automatic CPU frequency optimizer");
        println!();
        println!("Commands:");
    ...
    if args.iter().any(|a| a == "--version") { println!("auto-cpufreq v2.3 (OurOS)"); return 0; }
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_auto_cpufreq(&["--version".to_string()], "auto-cpufreq"), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_auto_cpufreq(&[], "auto-cpufreq"), 0);
    }
}
