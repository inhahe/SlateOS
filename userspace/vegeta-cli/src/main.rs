...
fn run_vegeta(args: &[String]) -> i32 {
    ...
    match subcmd {
        ...
        "report" => {
            ...
            match report_type {
                "json" => {
                    println!("{{");
                    println!(
                        "  \"latencies\": {{\"total\": 2345678900, \"mean\": 46913, \"50th\": 34200, \"90th\": 89100, \"95th\": 123400, \"99th\": 234500, \"max\": 567800}},"
                    );
                ...
                _ => {
                    ...
                    println!(
                        "Latencies     [min, mean, 50, 90, 95, 99, max]  0.342ms, 0.469ms, 0.342ms, 0.891ms, 1.234ms, 2.345ms, 5.678ms"
                    );
        ...
        _ => println!("vegeta: unknown command {}", quoteaf_os(subcmd)),
    }
    0
}
...
fn main() {
    ...
    let _prog = args
        ...
        .unwrap_or_else(|| "vegeta".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_vegeta, strip_ext};
