...
//! odt2txt-cli — OurOS OpenDocument to text converter
//!
...
fn run_odt2txt(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("odt2txt v0.5 (OurOS) — OpenDocument to plain text converter");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("odt2txt v0.5 (OurOS)"); return 0; }
