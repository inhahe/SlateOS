...
fn run_fuzzel(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("fuzzel v1.10 (Slate OS) — Application launcher and fuzzy finder");
        println!();
        println!("Options:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "fuzzel".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_fuzzel, strip_ext};
