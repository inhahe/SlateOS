...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "dust3d".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_dust3d, strip_ext};
    ...
    fn help_exits_zero() {
        ...
        let _ = run_dust3d(&["--version".to_string()], "dusty3d");
    }

    #[test]
    fn default_invocation_does_not_panic() {
        let _ = run_dust3d(&[], "dusty3d");
    }
}
