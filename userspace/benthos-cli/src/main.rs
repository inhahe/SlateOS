...
fn run_benthos(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("Benthos / Redpanda Connect 4.31.0 (Slate OS)");
        println!();
        println!("Commands:");
    ...
    match subcmd {
        ...
        _ => println!("benthos: {} completed", quoteaf_os(subcmd)),
    }
    0
}
...
fn main() {
    ...
    let _prog = args
        ...
        .unwrap_or_else(|| "benthos".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_benthos, strip_ext};
