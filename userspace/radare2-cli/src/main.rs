...
fn run_radare2(args: &[String], prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        match prog {
            "rabin2" => {
                println!("rabin2 (Slate OS) — Binary information extractor");
            ...
            "rasm2" => {
                println!("rasm2 (Slate OS) — Assembler/disassembler");
            ...
            "rahash2" => {
                println!("rahash2 (Slate OS) — Hash/checksum tool");
    ...
    if args.iter().any(|a| a == "--version") { println!("radare2 v5.9.0 (Slate OS)"); return 0; }
    match prog {
        "rabin2" => {
        ...
        _ => {
            println!("radare2 v5.9.0 (Slate OS)");
