...
//! unoconv-cli — OurOS universal document converter
//!
...
fn run_unoconv(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("unoconv v0.9 (OurOS) — Universal Office document converter");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("unoconv v0.9 (OurOS)"); return 0; }
