...
fn run_zmap(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("zmap v3.0 (Slate OS) — Fast single-packet network scanner");
        println!();
        println!("Options:");
...
#[cfg(test)]
mod tests {
    use super::{basename, run_zmap, strip_ext};
