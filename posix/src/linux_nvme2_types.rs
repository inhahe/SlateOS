//! `<linux/nvme_ioctl.h>` — NVMe device constants (extended).
//!
//! Extended NVMe constants covering admin commands, I/O
//! commands, status codes, feature identifiers, and
...
pub const NVME_SC_ABORT_QUEUE: u16 = 0x8;
/// Abort due to failed fuse.
pub const NVME_SC_FUSED_FAIL: u16 = 0x9;
/// Abort due to missing fuse.
pub const NVME_SC_FUSED_MISSING: u16 = 0xA;
/// Invalid namespace or format.
pub const NVME_SC_INVALID_NS: u16 = 0xB;
...
mod tests {
    ...
    fn test_features_distinct() {
        let feats = [
            ...
            NVME_FEAT_ASYNC_EVENT, NVME_FEAT_HOST_MEM_BUF,
        ];
    ...
    #[test]
    fn test_identify_opcode() {
        assert_eq!(NVME_ADM_CMD_IDENTIFY, 0x06);
    }
