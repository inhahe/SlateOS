...
fn run_coda(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Coda (Slate OS) — Doc-as-app: docs + tables + formulas + automations");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Coda 1.124.0 (Slate OS)"); return 0; }
    println!("Coda 1.124.0 (Slate OS)");
