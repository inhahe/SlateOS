...
//! zmq-cli — Slate OS ZeroMQ CLI tool
//!
...
fn run_zmq(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("zmq v1.0.0 (Slate OS) — ZeroMQ CLI tool");
        println!();
        println!("Commands:");
...
#[cfg(test)]
mod tests {
    use super::{basename, run_zmq, strip_ext};
