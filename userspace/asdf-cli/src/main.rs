...
mod tests {
    ...
    fn basename_strips_path() {
        assert_eq!(basename("/usr/bin/asdf"), "asdf");
        assert_eq!(basename(r"C:\bin\asdf.exe"), "asdf.exe");
        assert_eq!(basename("plain"), "plain");
    }

    #[test]
    fn strip_ext_removes_extension() {
        assert_eq!(strip_ext("asdf.exe"), "asdf");
        assert_eq!(strip_ext("no-ext"), "no-ext");
    }

    #[test]
    fn help_and_version_exit_zero() {
        assert_eq!(run_asdf(&["--help".to_string()], "asdf"), 0);
        assert_eq!(run_asdf(&["-h".to_string()], "asdf"), 0);
        assert_eq!(run_asdf(&["--version".to_string()], "asdf"), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_asdf(&[], "asdf"), 0);
    }
}
