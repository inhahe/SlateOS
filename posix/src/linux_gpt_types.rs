...
pub const GPT_TYPE_UNUSED: (u32, u16, u16, [u8; 8]) =
    (0x0000_0000, 0x0000, 0x0000, [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]);
...
pub const GPT_TYPE_MS_BASIC_DATA: (u32, u16, u16, [u8; 8]) =
    (0xEBD0_A0A2, 0xB9E5, 0x4433, [0x87, 0xC0, 0x68, 0xB6, 0xB7, 0x26, 0x99, 0xC7]);

/// Linux Filesystem Data: 0FC63DAF-8483-4772-8E79-3D69D8477DE4
pub const GPT_TYPE_LINUX_FS: (u32, u16, u16, [u8; 8]) =
    (0x0FC6_3DAF, 0x8483, 0x4772, [0x8E, 0x79, 0x3D, 0x69, 0xD8, 0x47, 0x7D, 0xE4]);

/// Linux Swap: 0657FD6D-A4AB-43C4-84E5-0933C84B4F4F
pub const GPT_TYPE_LINUX_SWAP: (u32, u16, u16, [u8; 8]) =
    (0x0657_FD6D, 0xA4AB, 0x43C4, [0x84, 0xE5, 0x09, 0x33, 0xC8, 0x4B, 0x4F, 0x4F]);

/// Linux LVM: E6D6D379-F507-44C2-A23C-238F2A3DF928
pub const GPT_TYPE_LINUX_LVM: (u32, u16, u16, [u8; 8]) =
    (0xE6D6_D379, 0xF507, 0x44C2, [0xA2, 0x3C, 0x23, 0x8F, 0x2A, 0x3D, 0xF9, 0x28]);
...
pub const GPT_TYPE_LINUX_HOME: (u32, u16, u16, [u8; 8]) =
    (0x933A_C7E1, 0x2EB4, 0x4F13, [0xB8, 0x44, 0x0E, 0x14, 0xE2, 0xAE, 0xF9, 0x15]);

/// Linux Root (x86-64): 4F68BCE3-E8CD-4DB1-96E7-FBCAF984B709
pub const GPT_TYPE_LINUX_ROOT_X86_64: (u32, u16, u16, [u8; 8]) =
    (0x4F68_BCE3, 0xE8CD, 0x4DB1, [0x96, 0xE7, 0xFB, 0xCA, 0xF9, 0x84, 0xB7, 0x09]);
