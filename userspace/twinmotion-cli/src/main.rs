...
//! twinmotion-cli — OurOS Twinmotion (Epic/Unreal-powered ArchViz)
//!
...
fn run_tm(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Twinmotion 2024 (OurOS) — Real-time ArchViz on Unreal Engine 5");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Twinmotion 2024.1 (OurOS)"); return 0; }
    println!("Twinmotion 2024.1 (OurOS)");
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_tm(&["--version".to_string()], "twinmotion"), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_tm(&[], "twinmotion"), 0);
    }
}
