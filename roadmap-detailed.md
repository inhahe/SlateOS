...
- [ ] Optional preview panel: shows currently selected image/video, movable and resizable (uses dockable panel widget) *Checked 2026-09-16: genuinely unstarted — no preview panel, state or toggle anywhere in `apps/explorer`.*
