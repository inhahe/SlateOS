...
fn run_havoc(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("havoc v0.5 (Slate OS) — Minimal Wayland terminal emulator");
        println!();
        println!("Options:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "havoc".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_havoc, strip_ext};
