...
fn run_chroot(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!();
        println!("chroot — run command with special root directory (Slate OS).");
        println!();
        println!("Options:");
...
fn run_unshare(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!();
        println!("unshare — run in new namespaces (Slate OS).");
        println!();
        println!("Options:");
...
fn run_pivot_root(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!();
        println!("pivot_root — change the root filesystem (Slate OS).");
        return 0;
    }
