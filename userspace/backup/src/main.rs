...
///
/// The implementation used to live here: 180 lines of round constants, message
/// schedule and compression function, one of ten such copies under
/// `userspace/`. It comes from `sha2` now, the crate that exists to hold
/// exactly one of them; see that crate's module docs for why a hash is the
/// worst thing to keep ten copies of.
