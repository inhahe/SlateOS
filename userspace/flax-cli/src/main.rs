...
fn run_flax(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Options:");
        println!(
            "  --platform PLAT    Target (Windows/Linux/Mac/Android/iOS/PS4/PS5/XboxOne/XboxScarlett/Switch)"
        );
...
#[cfg(test)]
mod tests {
    use super::{basename, run_flax, strip_ext};
