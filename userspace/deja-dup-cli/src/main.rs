...
fn run_deja_dup(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("deja-dup v44.0 (Slate OS) — Simple backup tool");
        println!();
        println!("Commands:");
    ...
    if args.iter().any(|a| a == "--version") { println!("deja-dup v44.0 (Slate OS)"); return 0; }
...
fn run_monitor(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("deja-dup-monitor v44.0 (Slate OS) — Backup monitor daemon");
        return 0;
    }
    if args.iter().any(|a| a == "--version") { println!("deja-dup-monitor v44.0 (Slate OS)"); return 0; }
