...
//! vivaldi-cli — OurOS Vivaldi browser (power user)
//!
...
fn run_vv(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Vivaldi (OurOS) — Power-user Chromium browser with deep customization");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Vivaldi 7.0.3495.29 (Stable channel) (OurOS, 64-bit)"); return 0; }
    println!("Vivaldi 7.0.3495.29 (OurOS)");
