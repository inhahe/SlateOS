...
fn run_energia(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Energia 1.8.10E23 (Slate OS) — Arduino-style IDE for TI LaunchPads");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Energia 1.8.10E23 (Slate OS)"); return 0; }
    println!("Energia 1.8.10E23 (Slate OS)");
