...
fn run_sf(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Snowflake Data Cloud (Slate OS) — Cloud data warehouse + lakehouse + AI");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Snowflake CLI 2.7.0 / Account 8.27 (Slate OS)"); return 0; }
    println!("Snowflake Data Cloud (Slate OS)");
