...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "msfconsole".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_metasploit, strip_ext};
    ...
    fn help_exits_zero() {
        ...
        let _ = run_metasploit(&["--version".to_string()], "metasploit");
    }

    #[test]
    fn default_invocation_does_not_panic() {
        let _ = run_metasploit(&[], "metasploit");
    }
}
