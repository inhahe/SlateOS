...
fn run_valentina(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("valentina-studio v13.5 (Slate OS) — Universal database IDE");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") {
        println!("valentina-studio v13.5 (Slate OS)");
        return 0;
    }
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "valentina-studio".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_valentina, strip_ext};
    ...
    fn help_exits_zero() {
        ...
        let _ = run_valentina(&["--version".to_string()], "valentina");
    }

    #[test]
    fn default_invocation_does_not_panic() {
        let _ = run_valentina(&[], "valentina");
    }
}
