...
//! monogame-cli — OurOS MonoGame (open-source XNA successor)
//!
...
fn run_mg(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("MonoGame 3.8.2 (OurOS) — Cross-platform .NET game framework (XNA spiritual successor)");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("MonoGame 3.8.2.1105 (OurOS)"); return 0; }
    println!("MonoGame 3.8.2.1105 (OurOS)");
