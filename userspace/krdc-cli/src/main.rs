...
fn run_krdc(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("krdc v23.08 (Slate OS) — KDE Remote Desktop Connection");
        println!();
        println!("Options:");
...
#[cfg(test)]
mod tests {
    use super::{basename, run_krdc, strip_ext};
    ...
    fn help_exits_zero() {
        ...
        let _ = run_krdc(&["--version".to_string()], "krdc");
    }
