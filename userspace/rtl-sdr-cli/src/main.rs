...
fn run_rtl(args: &[String], prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        match prog {
            "rtl_fm" => {
                ...
                println!("rtl_fm v0.6 (Slate OS) — FM demodulator");
            ...
            "rtl_power" => {
                ...
                println!("rtl_power v0.6 (Slate OS) — Wideband spectrum scanner");
            ...
            "rtl_test" => {
                ...
                println!("rtl_test v0.6 (Slate OS) — RTL-SDR benchmark");
                println!("  -s RATE    Sample rate");
            ...
            "rtl_tcp" => {
                ...
                println!("rtl_tcp v0.6 (Slate OS) — I/Q spectrum server");
            ...
            _ => {
                ...
                println!("rtl_sdr v0.6 (Slate OS) — I/Q recorder");
    ...
    if args.iter().any(|a| a == "--version") {
        println!("rtl-sdr v0.6.0 (Slate OS)");
        return 0;
    }
    match prog {
        "rtl_test" => {
...
#[cfg(test)]
mod tests {
    use super::{basename, run_rtl, strip_ext};
