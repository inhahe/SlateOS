...
//! sendmail-cli — OurOS sendmail/msmtp CLI
//!
...
fn run_sendmail(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!();
        println!("sendmail — mail transfer agent (OurOS).");
        println!();
        println!("Options:");
...
fn run_msmtp(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!();
        println!("msmtp — lightweight SMTP client (OurOS).");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") {
        println!("msmtp version 1.8.25 (OurOS)");
        return 0;
    }
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_sendmail(&["--version".to_string()]), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_sendmail(&[]), 0);
    }
}
