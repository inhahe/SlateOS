...
fn run_premiere(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Adobe Premiere Pro 2024 (Slate OS) — Professional video editing");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Adobe Premiere Pro 2024 v24.5.0 (Slate OS)"); return 0; }
    println!("Adobe Premiere Pro 2024 v24.5.0 (Slate OS)");
