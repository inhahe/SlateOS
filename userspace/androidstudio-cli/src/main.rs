...
fn run_as(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Android Studio Ladybug 2024.2.2 (Slate OS) — Google's IDE for Android development");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Android Studio Ladybug | 2024.2.2 Patch 1 (Slate OS)"); return 0; }
