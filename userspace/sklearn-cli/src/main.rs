...
//! sklearn-cli — OurOS scikit-learn machine learning library
//!
...
fn run_sklearn(args: &[String]) -> i32 {
    ...
    match subcmd {
        "version" | "--version" => println!("scikit-learn 1.4.0 (OurOS)"),
        "info" | "show-versions" => {
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_sklearn(&["--version".to_string()]), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_sklearn(&[]), 0);
    }
}
