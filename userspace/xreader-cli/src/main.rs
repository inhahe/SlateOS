...
fn run_xreader(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("xreader v4.0 (Slate OS) — Linux Mint document reader");
        println!();
        println!("Options:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "xreader".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_xreader, strip_ext};
