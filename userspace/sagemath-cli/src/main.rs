...
//! sagemath-cli — OurOS SageMath mathematics system
//!
...
fn run_sage(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("sage v10.3 (OurOS) — Open-source mathematics system");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("sage v10.3 (OurOS)"); return 0; }
...
fn run_notebook(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("sage-notebook v10.3 (OurOS) — SageMath notebook server");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("sage-notebook v10.3 (OurOS)"); return 0; }
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_sage(&["--version".to_string()], "sagemath"), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_sage(&[], "sagemath"), 0);
    }
}
