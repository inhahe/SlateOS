...
//! spss-cli — OurOS IBM SPSS Statistics
//!
...
fn run_spss(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("IBM SPSS Statistics 30 (OurOS) — Statistical analysis software");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("IBM SPSS Statistics 30.0.0.0 (OurOS)"); return 0; }
    println!("IBM SPSS Statistics 30.0.0.0 (OurOS)");
