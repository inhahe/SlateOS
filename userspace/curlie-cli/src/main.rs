...
fn run_curlie(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("curlie v1.7.2 (Slate OS) — curl with HTTPie-style output");
        println!();
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "curlie".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_curlie, strip_ext};
