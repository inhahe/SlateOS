//! VP8's constant tables, as RFC 6386 prints them.
//!
//! Generated from the RFC's text, which carries each of these twice -- once in
//! the prose (sections 11.5, 13.4, 13.5 and 14.1) and once in its reference
//! decoder's source (section 20) -- and written only after both copies agreed to
...
/// mode numbering: DC, TM, VE, HE, LD, RD, VR, VL, HD, HU.
pub(super) const KF_BMODE_PROBS: [[[u8; 9]; 10]; 10] = [
    [
...
/// DC dequantization factors by quantizer index (RFC 6386 §14.1).
pub(super) const DC_QUANT: [u16; 128] = [
...
/// AC dequantization factors by quantizer index (RFC 6386 §14.1).
pub(super) const AC_QUANT: [u16; 128] = [
