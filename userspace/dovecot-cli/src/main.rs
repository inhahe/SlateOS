...
fn run_dovecot(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!();
        println!("Dovecot — IMAP/POP3 server (Slate OS).");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") {
        println!("dovecot 2.3.21 (Slate OS)");
        return 0;
    }
...
fn run_doveconf(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!();
        println!("doveconf — dump Dovecot configuration (Slate OS).");
        println!();
        println!("Options:");
...
fn run_doveadm(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!();
        println!("doveadm — Dovecot administration tool (Slate OS).");
        println!();
        println!("Commands:");
...
mod tests {
    ...
    fn help_exits_zero() {
        ...
        let _ = run_dovecot(&["--version".to_string()]);
    }
