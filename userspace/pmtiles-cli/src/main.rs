...
//! pmtiles-cli — OurOS PMTiles archive tool
//!
...
fn run_pmtiles(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("pmtiles v1.11 (OurOS) — PMTiles archive utility");
        println!();
        println!("Commands:");
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_pmtiles(&["--version".to_string()], "pmtiles"), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_pmtiles(&[], "pmtiles"), 0);
    }
}
