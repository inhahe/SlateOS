...
fn run_waypipe(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("waypipe v0.9 (Slate OS) — Proxy Wayland connections over SSH");
        println!();
        println!("Commands:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "waypipe".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_waypipe, strip_ext};
    ...
    fn help_exits_zero() {
        ...
        let _ = run_waypipe(&["--version".to_string()], "waypipe");
    }

    #[test]
    fn default_invocation_does_not_panic() {
        let _ = run_waypipe(&[], "waypipe");
    }
}
