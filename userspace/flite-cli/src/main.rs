...
fn run_flite(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("Flite v2.2 (Slate OS) — Lightweight speech synthesis");
        println!();
        println!("Options:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "flite".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_flite, strip_ext};
