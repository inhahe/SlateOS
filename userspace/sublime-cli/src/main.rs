...
//! sublime-cli — OurOS Sublime Text (Jon Skinner's classic fast editor)
//!
...
fn run_st(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Sublime Text 4 (build 4180) (OurOS) — Fast cross-platform text editor");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Sublime Text 4 Build 4180 (OurOS)"); return 0; }
    println!("Sublime Text 4 Build 4180 (OurOS)");
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_st(&["--version".to_string()], "sublime"), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_st(&[], "sublime"), 0);
    }
}
