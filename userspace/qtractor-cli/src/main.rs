...
fn run_qtractor(args: &[String], _prog: &str) -> i32 {
    ...
    if args.iter().any(|a| a == "--version") {
        println!("Qtractor v0.9.39 (Slate OS)");
        return 0;
    }
...
fn main() {
    ...
    let _prog = args
        ...
        .unwrap_or_else(|| "qtractor".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_qtractor, strip_ext};
    ...
    fn help_exits_zero() {
        ...
        let _ = run_qtractor(&["--version".to_string()], "qtractor");
    }

    #[test]
    fn default_invocation_does_not_panic() {
        let _ = run_qtractor(&[], "qtractor");
    }
}
