...
fn run_kk(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("NI Komplete Kontrol 3 (SlateOS) — Plug-in host & NKS browser for KK keyboards");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("NI Komplete Kontrol 3.1.0 (SlateOS)"); return 0; }
    println!("NI Komplete Kontrol 3.1.0 (SlateOS)");
