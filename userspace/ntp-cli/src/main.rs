...
fn run_ntpd(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!();
        println!("ntpd — NTP daemon (Slate OS).");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") {
        println!("ntpd 4.2.8p17 (Slate OS)");
        return 0;
    }
...
fn run_ntpq(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!();
        println!("ntpq — NTP query program (Slate OS).");
        println!();
        println!("Options:");
    ...
    if peers {
        ...
        println!("version=\"ntpd 4.2.8p17 (Slate OS)\",");
...
fn run_ntpdate(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!();
        println!("ntpdate — set the date and time via NTP (Slate OS).");
        println!();
        println!("Options:");
...
fn run_chronyc(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!();
        println!("chronyc — chronyd control program (Slate OS).");
        println!();
        println!("Commands: sources, sourcestats, tracking, ntpdata, activity, makestep");
        return 0;
    }
    if args.iter().any(|a| a == "--version" || a == "-v") {
        println!("chronyc (chrony) version 4.5 (Slate OS)");
        return 0;
    }
...
fn run_chronyd(args: &[String]) -> i32 {
    ...
    if args.iter().any(|a| a == "--version" || a == "-v") {
        println!("chronyd (chrony) version 4.5 (Slate OS)");
        return 0;
    }
