...
pub fn self_test() -> KernelResult<()> {
    ...
    let _pristine_total_probes_sent = crate::fs::selftest::pristine_atomic(&TOTAL_PROBES_SENT, 0);
    let _pristine_total_probes_timeout =
        crate::fs::selftest::pristine_atomic(&TOTAL_PROBES_TIMEOUT, 0);
    let _pristine_last_hops = crate::fs::selftest::pristine_atomic(&LAST_HOPS, 0);
    let _pristine_active6 = crate::fs::selftest::pristine_atomic(&ACTIVE6, false);
    let _pristine_total_traces6 = crate::fs::selftest::pristine_atomic(&TOTAL_TRACES6, 0);
    let _pristine_total_probes_sent6 = crate::fs::selftest::pristine_atomic(&TOTAL_PROBES_SENT6, 0);
    let _pristine_total_probes_timeout6 =
        crate::fs::selftest::pristine_atomic(&TOTAL_PROBES_TIMEOUT6, 0);
    let _pristine_last_hops6 = crate::fs::selftest::pristine_atomic(&LAST_HOPS6, 0);
    self_test_inner()
}
