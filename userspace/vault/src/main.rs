...
//! vault — OurOS secrets management
//!
...
fn run_vault(args: Vec<String>) -> i32 {
    ...
    match cmd.as_str() {
        ...
        "version" | "--version" | "-v" => {
            println!("Vault v1.16.2 (OurOS), built 2025-05-22T00:00:00Z");
            0
        }
        "server" => {
            ...
            if is_dev {
                ...
                println!("                 Version: Vault v1.16.2 (OurOS)");
                println!();
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_vault(vec!["--version".to_string()]), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_vault(vec![]), 0);
    }
}
