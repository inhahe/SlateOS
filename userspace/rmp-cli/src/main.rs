...
fn run_rmp(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("msgpack-inspect v1.0 (Slate OS) — MessagePack binary inspector");
        println!();
        println!("Options:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "msgpack-inspect".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_rmp, strip_ext};
