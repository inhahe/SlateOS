...
//! kgeography-cli — OurOS KGeography geography learning
//!
...
fn run_kgeography(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("kgeography v23.08 (OurOS) — Geography learning tool");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("kgeography v23.08 (OurOS)"); return 0; }
