...
fn run_labwc(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("labwc v0.7 (Slate OS) — Wayland stacking compositor (Openbox-like)");
        println!();
        println!("Options:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "labwc".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_labwc, strip_ext};
