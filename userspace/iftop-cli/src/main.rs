...
//! iftop-cli — OurOS iftop network bandwidth monitor
//!
...
fn run_iftop(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("iftop 1.0pre4 (OurOS) — Network bandwidth monitor");
        println!();
        println!("Options:");
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_iftop(&["--version".to_string()], "iftop"), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_iftop(&[], "iftop"), 0);
    }
}
