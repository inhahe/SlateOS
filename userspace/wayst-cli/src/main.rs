...
fn run_wayst(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("wayst v0.1 (Slate OS) — GPU-accelerated Wayland terminal");
        println!();
        println!("Options:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "wayst".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_wayst, strip_ext};
