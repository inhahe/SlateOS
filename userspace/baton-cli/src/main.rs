...
fn run_baton(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Baton v0.9 (Slate OS) — Identity & access connector");
        println!();
        println!("Commands:");
...
fn main() {
    ...
    let _prog = args
        ...
        .unwrap_or_else(|| "baton".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_baton, strip_ext};
