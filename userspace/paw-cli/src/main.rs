...
fn run_paw(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("Paw v4.0.0 (Slate OS) — API development tool");
        println!();
        println!("Commands:");
...
#[cfg(test)]
mod tests {
    use super::{basename, run_paw, strip_ext};
    ...
    fn help_exits_zero() {
        ...
        let _ = run_paw(&["--version".to_string()], "paw");
    }
