...
fn run_gping(args: Vec<String>) -> i32 {
    ...
    println!("gping 1.17.3 (OurOS) — TUI launched");
    println!();
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_gping(vec!["--version".to_string()]), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_gping(vec![]), 0);
    }
}
