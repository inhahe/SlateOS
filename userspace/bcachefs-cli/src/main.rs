...
fn run_bcachefs(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("bcachefs v1.7 (Slate OS) — Copy-on-write filesystem tools");
        println!();
        println!("Commands:");
    ...
    if args.iter().any(|a| a == "--version") { println!("bcachefs v1.7.0 (Slate OS)"); return 0; }
    println!("bcachefs v1.7.0 (Slate OS)");
