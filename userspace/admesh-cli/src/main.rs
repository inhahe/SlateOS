...
//! admesh-cli — OurOS ADMesh STL mesh processor
//!
...
fn run_admesh(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("ADMesh v0.98 (OurOS) — STL mesh processing tool");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("ADMesh v0.98.4 (OurOS)"); return 0; }
