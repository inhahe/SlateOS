...
//! pulsemixer-cli — OurOS pulsemixer audio mixer
//!
...
fn run_pulsemixer(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("pulsemixer 1.5.1 (OurOS) — CLI and curses mixer for PulseAudio");
        println!();
        println!("Options:");
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_pulsemixer(&["--version".to_string()], "pulsemixer"), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_pulsemixer(&[], "pulsemixer"), 0);
    }
}
