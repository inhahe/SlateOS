...
def load_module(path, name):
    ...
    This suite calls it once per test -- thirty times -- against a file that
    a developer is often editing between runs, so it is the one here most
    exposed to the stale-cache window.
    """
