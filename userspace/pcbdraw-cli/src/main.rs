...
fn run_pcbdraw(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("PcbDraw v1.1 (Slate OS) — Render KiCad PCBs to images");
        println!();
        println!("Options:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "pcbdraw".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_pcbdraw, strip_ext};
    ...
    fn help_exits_zero() {
        ...
        let _ = run_pcbdraw(&["--version".to_string()], "pcbdraw");
    }

    #[test]
    fn default_invocation_does_not_panic() {
        let _ = run_pcbdraw(&[], "pcbdraw");
    }
}
