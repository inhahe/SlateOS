...
fn run_mistika(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("SGO Mistika Boutique 10 (Slate OS) — High-end VR, stitching, color, finishing");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("SGO Mistika Boutique 10.13.5 (Slate OS)"); return 0; }
    println!("SGO Mistika Boutique 10.13.5 (Slate OS)");
