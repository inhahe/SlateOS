...
//! sketch-cli — OurOS Sketch macOS design tool
//!
...
fn run_sk(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Sketch 100 (OurOS) — macOS-native vector design tool");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Sketch 100.3 (OurOS)"); return 0; }
    println!("Sketch 100.3 (OurOS)");
