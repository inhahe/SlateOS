...
fn run_chuck(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("ChucK v1.5.2 (Slate OS) — Strongly-timed audio programming");
        println!();
        println!("Options:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "chuck".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_chuck, strip_ext};
    ...
    fn help_exits_zero() {
        ...
        let _ = run_chuck(&["--version".to_string()], "chuck");
    }

    #[test]
    fn default_invocation_does_not_panic() {
        let _ = run_chuck(&[], "chuck");
    }
}
