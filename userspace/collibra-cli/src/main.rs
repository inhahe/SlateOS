...
//! collibra-cli — OurOS Collibra (data intelligence + governance, Brussels + NYC)
...
fn run_collibra(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Collibra (OurOS) — data intelligence platform (catalog + governance leader)");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Collibra 2024.07 (OurOS)"); return 0; }
    println!("Collibra 2024.07 (OurOS) — Data Intelligence Platform");
