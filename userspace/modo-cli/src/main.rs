...
fn run_modo(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Foundry Modo 17 (Slate OS) — 3D modeling, sculpting & rendering");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Foundry Modo 17.0v5 (Slate OS)"); return 0; }
    println!("Foundry Modo 17.0v5 (Slate OS)");
