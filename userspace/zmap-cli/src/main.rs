...
//! zmap-cli — OurOS ZMap network scanner
//!
...
fn run_zmap(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("zmap v3.0 (OurOS) — Fast single-packet network scanner");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("zmap v3.0 (OurOS)"); return 0; }
