...
//! zookeeper — OurOS distributed coordination service
//!
...
fn run_zk_server(args: Vec<String>) -> i32 {
    ...
    match cmd {
        "version" | "--version" => {
            println!("Apache ZooKeeper, version 3.9.2 (OurOS)");
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_zk_server(vec!["--version".to_string()]), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_zk_server(vec![]), 0);
    }
}
