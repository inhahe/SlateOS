...
//! turbostat-cli — OurOS turbostat CPU frequency & power monitor
//!
...
fn run_turbostat(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("turbostat v2024.01 (OurOS) — CPU frequency, idle, power stats");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("turbostat v2024.01 (OurOS)"); return 0; }
