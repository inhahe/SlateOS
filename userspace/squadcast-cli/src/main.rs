...
//! squadcast-cli — OurOS SquadCast remote podcast recording
//!
...
fn run_sc(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("SquadCast (Descript) (OurOS) — Studio-quality remote recording");
        println!();
        println!("Commands:");
    ...
    if args.iter().any(|a| a == "--version") { println!("SquadCast (Descript Acquired) v4.0 (OurOS)"); return 0; }
    println!("SquadCast (OurOS) — now part of Descript");
