...
//! d3-cli — OurOS D3.js data visualization CLI
//!
...
fn run_d3(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("d3 v7.0 (OurOS) — Data-driven document visualization CLI");
        println!();
        println!("Commands:");
    ...
    if args.iter().any(|a| a == "--version") { println!("d3-cli v7.0.0 (OurOS, based on D3.js)"); return 0; }
