...
mod tests {
    ...
    fn strip_ext_removes_extension() {
        assert_eq!(strip_ext("gnome-screenshot.exe"), "gnome-screenshot");
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_gnome_screenshot(&["--version".to_string()], "gnome-screenshot"), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_gnome_screenshot(&[], "gnome-screenshot"), 0);
    }
}
