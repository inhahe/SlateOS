...
fn run_fb(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("FreshBooks (Slate OS) — Cloud accounting for freelancers, agencies, service businesses");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("FreshBooks 2024 (Slate OS)"); return 0; }
