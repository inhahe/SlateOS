...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "wings3d".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_wings3d, strip_ext};
    ...
    fn help_exits_zero() {
        ...
        let _ = run_wings3d(&["--version".to_string()], "wings3d");
    }

    #[test]
    fn default_invocation_does_not_panic() {
        let _ = run_wings3d(&[], "wings3d");
    }
}
