...
fn run_airbyte(args: &[String]) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("Airbyte CLI (Octavia) 0.44.0 (Slate OS)");
        println!();
        println!("Commands:");
    ...
    match subcmd {
        ...
        _ => println!("octavia: {} completed", quoteaf_os(subcmd)),
    }
    0
}
...
fn main() {
    ...
    let _prog = args
        ...
        .unwrap_or_else(|| "octavia".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_airbyte, strip_ext};
    ...
    fn help_exits_zero() {
        ...
        let _ = run_airbyte(&["--version".to_string()]);
    }
