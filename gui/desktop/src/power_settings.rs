...
impl Default for PowerSettingsUI {
    fn default() -> Self {
        Self::new()
    }
}
                    ...
                    for plan in PowerPlan::ALL {
                        for tab in 0..4 {
                            ...
                            for width in [320.0_f32, 500.0, 900.0] {
                                ...
                                // — one of the two extremes, not a role. The
                                // tracks are named rather than the extremes,
                                // so the exemption stays tied to its fill.
                                assert_drawn_from(
                                    &p,
                                    &cmds,
                                    &[
