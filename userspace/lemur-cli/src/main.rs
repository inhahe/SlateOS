...
//! lemur-cli — OurOS Lemur certificate manager
//!
...
fn run_lemur(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Lemur v1.0 (OurOS) — TLS certificate management");
        println!();
        println!("Commands:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Lemur v1.0.0 (OurOS)"); return 0; }
    println!("Lemur v1.0.0 (OurOS)");
