...
fn run_trilium(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Trilium Notes v0.63 (Slate OS) — Hierarchical note-taking knowledge base");
        println!();
        println!("Commands:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Trilium Notes v0.63.7 (Slate OS)"); return 0; }
    println!("Trilium Notes v0.63.7 (Slate OS)");
    println!("  Notes: 3,456");
