...
fn run_petsc(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("PETSc v3.21 (Slate OS) — Portable Extensible Toolkit for Scientific Computation");
        println!();
        println!("Commands:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "petsc-info".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_petsc, strip_ext};
