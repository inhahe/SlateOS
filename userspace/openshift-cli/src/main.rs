...
//! openshift-cli — OurOS Red Hat OpenShift Container Platform (oc)
//!
...
fn run_oc(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Red Hat OpenShift Container Platform 4.17 / oc 4.17 (OurOS)");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Client Version: 4.17.4 / Kubernetes Version: v1.30.5 / Server Version: 4.17.4 (OurOS)"); return 0; }
    println!("Red Hat OpenShift Container Platform 4.17 (OurOS)");
