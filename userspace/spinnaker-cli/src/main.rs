...
//! spinnaker-cli — OurOS Spinnaker continuous delivery
//!
...
fn run_spin(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Spinnaker CLI v1.30 (OurOS) — Multi-cloud continuous delivery");
        println!();
        println!("Commands:");
    ...
    if args.iter().any(|a| a == "--version") { println!("spin v1.30.0 (OurOS)"); return 0; }
    println!("Spinnaker CLI v1.30.0 (OurOS)");
