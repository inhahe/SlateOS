...
fn run_hydra(args: Vec<String>) -> i32 {
    ...
    println!(
        "[DATA] max {} tasks per 1 server, overall {} tasks",
        tasks, tasks
    );
    println!(
        "[DATA] attacking {}://{}:{}",
    ...
    println!(
        "[ATTEMPT] target {} - login \"{}\" - pass \"password\" - 1 of 1000",
        target, login
    );
    println!(
        "[ATTEMPT] target {} - login \"{}\" - pass \"123456\" - 2 of 1000",
        target, login
    );
    println!(
        "[ATTEMPT] target {} - login \"{}\" - pass \"admin\" - 3 of 1000",
        target, login
    );
    println!(
        "[22][{}] host: {}   login: {}   password: admin123",
        service, target, login
    );
