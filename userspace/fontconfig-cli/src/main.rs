...
//! fontconfig-cli — OurOS Fontconfig font configuration
//!
...
fn run_fc_list(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("fc-list v2.15 (OurOS) — List available fonts");
        return 0;
    }
    if args.iter().any(|a| a == "--version") { println!("fc-list v2.15 (OurOS)"); return 0; }
...
fn run_fc_match(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("fc-match v2.15 (OurOS) — Match font pattern");
        return 0;
    }
    if args.iter().any(|a| a == "--version") { println!("fc-match v2.15 (OurOS)"); return 0; }
...
fn run_fc_cache(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("fc-cache v2.15 (OurOS) — Build font cache");
        println!("  -f    Force rebuild");
        println!("  -v    Verbose");
        return 0;
    }
    if args.iter().any(|a| a == "--version") { println!("fc-cache v2.15 (OurOS)"); return 0; }
...
fn run_fc_query(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("fc-query v2.15 (OurOS) — Query font files");
        return 0;
    }
    if args.iter().any(|a| a == "--version") { println!("fc-query v2.15 (OurOS)"); return 0; }
...
fn run_fc_scan(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("fc-scan v2.15 (OurOS) — Scan font files and directories");
        return 0;
    }
    if args.iter().any(|a| a == "--version") { println!("fc-scan v2.15 (OurOS)"); return 0; }
