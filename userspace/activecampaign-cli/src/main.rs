...
//! activecampaign-cli — OurOS ActiveCampaign (SMB marketing automation + CRM)
//!
...
fn run_ac(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("ActiveCampaign (OurOS) — SMB marketing automation + sales CRM");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("ActiveCampaign 2024 (OurOS)"); return 0; }
    println!("ActiveCampaign 2024 (OurOS)");
