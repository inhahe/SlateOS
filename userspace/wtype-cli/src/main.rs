...
//! wtype-cli — OurOS wtype Wayland keyboard/mouse input simulator
//!
...
fn run_wtype(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("wtype v0.4 (OurOS) — Wayland keyboard/mouse input simulator");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("wtype v0.4 (OurOS)"); return 0; }
