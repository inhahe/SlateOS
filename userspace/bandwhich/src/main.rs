...
//! bandwhich — OurOS terminal bandwidth utilization tool
//!
...
fn run_bandwhich(args: Vec<String>) -> i32 {
    ...
    println!("bandwhich 0.22.2 (OurOS) — TUI launched");
    println!();
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_bandwhich(vec!["--version".to_string()]), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_bandwhich(vec![]), 0);
    }
}
