...
fn run_bd(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Bitdefender Total Security 27.0 (Slate OS) — Multi-platform security");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Bitdefender Total Security 27.0.43.221 (Slate OS)"); return 0; }
    println!("Bitdefender Total Security 27.0.43.221 (Slate OS)");
