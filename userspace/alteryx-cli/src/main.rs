...
//! alteryx-cli — OurOS Alteryx Analytics automation
//!
...
fn run_aterix(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Alteryx Designer 2024.2 (OurOS) — Self-service analytics automation");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Alteryx Designer 2024.2.1.4 (OurOS)"); return 0; }
    println!("Alteryx Designer 2024.2.1.4 (OurOS)");
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_aterix(&["--version".to_string()], "alteryx"), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_aterix(&[], "alteryx"), 0);
    }
}
