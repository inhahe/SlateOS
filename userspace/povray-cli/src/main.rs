...
//! povray-cli — OurOS POV-Ray ray tracer
//!
...
fn run_povray(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("POV-Ray v3.8 (OurOS) — Persistence of Vision Raytracer");
        println!();
        println!("Options:");
...
mod tests {
    ...
    fn help_and_version_exit_zero() {
        ...
        assert_eq!(run_povray(&["--version".to_string()], "povray"), 0);
    }

    #[test]
    fn default_invocation_exits_zero() {
        assert_eq!(run_povray(&[], "povray"), 0);
    }
}
