    ...
    *guard = Some(State {
        sets: alloc::vec![
            CpuSet {
                ...
                processes: 100,
                exclusive: false,
                affinity_changes: 500_000
            },
            CpuSet {
                id: 2,
                name: String::from("realtime"),
                cpu_mask: 0x3,
                mem_mask: 0x1,
                processes: 5,
                exclusive: true,
                affinity_changes: 1_000
            },
            CpuSet {
                id: 3,
