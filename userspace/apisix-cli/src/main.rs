...
fn run_apisix(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Apache APISIX v3.9 (Slate OS) — Dynamic API gateway");
        println!();
        println!("Commands:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Apache APISIX v3.9.1 (Slate OS)"); return 0; }
    println!("Apache APISIX v3.9.1 (Slate OS)");
