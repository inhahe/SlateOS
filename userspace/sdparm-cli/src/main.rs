...
fn run_sdparm(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("sdparm v1.12 (Slate OS) — SCSI device parameter utility");
        println!();
        println!("Options:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "sdparm".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_sdparm, strip_ext};
