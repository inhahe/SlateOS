...
impl PaintApp {
    ...
    fn render_option_bar(&self, cmds: &mut Vec<RenderCommand>) {
        ...
        cmds.push(RenderCommand::Text {
            ...
            font_size: 12.0,
            color: self.theme.ink(self.theme.yellow),
            font_weight: FontWeightHint::Regular,
            max_width: None,
            overflow: TextOverflow::Clip,
        });
        ...
        if matches!(
            ...
            cmds.push(RenderCommand::Text {
                ...
                font_size: 12.0,
                color: self.theme.ink(self.theme.lavender),
                font_weight: FontWeightHint::Regular,
                max_width: None,
                overflow: TextOverflow::Clip,
            });
        ...
        if self.grid.visible {
            cmds.push(RenderCommand::Text {
                ...
                font_size: 12.0,
                color: self.theme.ink(self.theme.green),
                font_weight: FontWeightHint::Regular,
                max_width: None,
                overflow: TextOverflow::Clip,
            });
    ...
    fn render_status_bar(&self, cmds: &mut Vec<RenderCommand>) {
        ...
        cmds.push(RenderCommand::Text {
            ...
            text: format!("Tool: {}", self.current_tool.label()),
            font_size: 11.0,
            color: self.theme.ink(self.theme.blue),
            font_weight: FontWeightHint::Regular,
            max_width: None,
            overflow: TextOverflow::Clip,
        });
        ...
        if let Some(sel) = &self.selection {
            ...
            cmds.push(RenderCommand::Text {
                ...
                font_size: 11.0,
                color: self.theme.ink(self.theme.peach),
                font_weight: FontWeightHint::Regular,
                max_width: None,
                overflow: TextOverflow::Clip,
            });
