...
fn run_env0(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("env0 v2.0 (SlateOS) — Environment-as-a-Service platform");
        println!();
        println!("Commands:");
    ...
    if args.iter().any(|a| a == "--version") { println!("env0 v2.0.1 (SlateOS)"); return 0; }
    println!("env0 v2.0.1 (SlateOS)");
