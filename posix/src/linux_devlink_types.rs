...
mod tests {
    ...
    fn test_commands_distinct() {
        let cmds = [
            DEVLINK_CMD_GET, DEVLINK_CMD_SET,
            DEVLINK_CMD_PORT_GET, DEVLINK_CMD_PORT_SET,
            DEVLINK_CMD_PORT_SPLIT, DEVLINK_CMD_PORT_UNSPLIT,
            DEVLINK_CMD_SB_GET, DEVLINK_CMD_PARAM_GET,
            DEVLINK_CMD_PARAM_SET,
            DEVLINK_CMD_HEALTH_REPORTER_GET, DEVLINK_CMD_HEALTH_REPORTER_SET,
            DEVLINK_CMD_HEALTH_REPORTER_RECOVER, DEVLINK_CMD_HEALTH_REPORTER_DIAGNOSE,
            DEVLINK_CMD_HEALTH_REPORTER_DUMP_GET, DEVLINK_CMD_FLASH_UPDATE,
            DEVLINK_CMD_TRAP_GET, DEVLINK_CMD_TRAP_SET,
            DEVLINK_CMD_TRAP_GROUP_GET, DEVLINK_CMD_TRAP_GROUP_SET,
            DEVLINK_CMD_RATE_GET, DEVLINK_CMD_RATE_SET,
            DEVLINK_CMD_SELFTESTS_GET, DEVLINK_CMD_SELFTESTS_RUN,
        ];
        for i in 0..cmds.len() {
