...
//! defold-cli — OurOS Defold game engine
//!
...
fn run_defold(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Defold v1.9 (OurOS) — Cross-platform 2D/3D game engine");
        println!();
        println!("Commands:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Defold v1.9.4 (OurOS)"); return 0; }
    println!("Defold v1.9.4 (OurOS)");
