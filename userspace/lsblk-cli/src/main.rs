...
fn run_lsblk(args: &[String]) -> i32 {
    ...
    if json {
        ...
        println!(
            "      {{\"name\":\"sda\", \"maj:min\":\"8:0\", \"rm\":false, \"size\":\"931.5G\", \"ro\":false, \"type\":\"disk\"}},"
        );
        println!(
            "      {{\"name\":\"sda1\", \"maj:min\":\"8:1\", \"rm\":false, \"size\":\"512M\", \"ro\":false, \"type\":\"part\", \"mountpoint\":\"/boot/efi\"}},"
        );
        println!(
            "      {{\"name\":\"sda2\", \"maj:min\":\"8:2\", \"rm\":false, \"size\":\"931G\", \"ro\":false, \"type\":\"part\", \"mountpoint\":\"/\"}},"
        );
        println!(
            "      {{\"name\":\"nvme0n1\", \"maj:min\":\"259:0\", \"rm\":false, \"size\":\"1.9T\", \"ro\":false, \"type\":\"disk\"}}"
        );
        println!("   ]");
        println!("}}");
        return 0;
    ...
    if fs_mode {
        ...
        println!("sda");
        println!(
            "├─sda1    vfat   FAT32 EFI    ABCD-1234                              450M     12% /boot/efi"
        );
        println!(
            "└─sda2    ext4   1.0          12345678-1234-1234-1234-123456789abc  800.2G    14% /"
        );
        println!("nvme0n1");
        println!(
            "├─nvme0n1p1 ext4 1.0   data   87654321-4321-4321-4321-cba987654321    1.5T     21% /data"
        );
        println!(
            "└─nvme0n1p2 swap 1            aabbccdd-eeff-0011-2233-445566778899                  [SWAP]"
        );
    } else {
...
fn run_blkid(args: &[String]) -> i32 {
    ...
    if let Some(dev) = device {
        println!(
            "{}: UUID=\"12345678-1234-1234-1234-123456789abc\" BLOCK_SIZE=\"4096\" TYPE=\"ext4\"",
            dev
        );
    } else {
        println!(
            "/dev/sda1: UUID=\"ABCD-1234\" BLOCK_SIZE=\"512\" TYPE=\"vfat\" PARTLABEL=\"EFI\" PARTUUID=\"11111111-2222-3333-4444-555555555555\""
        );
        println!(
            "/dev/sda2: UUID=\"12345678-1234-1234-1234-123456789abc\" BLOCK_SIZE=\"4096\" TYPE=\"ext4\" PARTUUID=\"66666666-7777-8888-9999-aaaaaaaaaaaa\""
        );
        println!(
            "/dev/nvme0n1p1: UUID=\"87654321-4321-4321-4321-cba987654321\" BLOCK_SIZE=\"4096\" TYPE=\"ext4\" PARTLABEL=\"data\" PARTUUID=\"bbbbbbbb-cccc-dddd-eeee-ffffffffffff\""
        );
        println!(
            "/dev/nvme0n1p2: UUID=\"aabbccdd-eeff-0011-2233-445566778899\" TYPE=\"swap\" PARTUUID=\"00112233-4455-6677-8899-aabbccddeeff\""
        );
    }
    0
}
...
#[cfg(test)]
mod tests {
    use super::{basename, run_lsblk, strip_ext};
