...
//! deluge-cli — OurOS Deluge BitTorrent client
//!
...
fn run_deluged(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("deluged v2.1 (OurOS) — Deluge BitTorrent daemon");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("deluged v2.1 (OurOS)"); return 0; }
...
fn run_console(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("deluge-console v2.1 (OurOS) — Deluge console interface");
        println!();
        println!("Commands:");
    ...
    if args.iter().any(|a| a == "--version") { println!("deluge-console v2.1 (OurOS)"); return 0; }
...
fn run_gtk(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("deluge-gtk v2.1 (OurOS) — Deluge GTK client");
        return 0;
    }
    if args.iter().any(|a| a == "--version") { println!("deluge-gtk v2.1 (OurOS)"); return 0; }
...
fn run_web(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("deluge-web v2.1 (OurOS) — Deluge web interface");
        println!();
        println!("Options:");
        println!("  -p PORT           Web UI port (default: 8112)");
        return 0;
    }
    if args.iter().any(|a| a == "--version") { println!("deluge-web v2.1 (OurOS)"); return 0; }
