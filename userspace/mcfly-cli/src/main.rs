...
fn run_mcfly(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") || args.is_empty() {
        ...
        println!("McFly 0.9.2 (Slate OS) — Neural network shell history search");
        println!();
        println!("Commands:");
...
fn main() {
    ...
    let prog = args
        ...
        .unwrap_or_else(|| "mcfly".to_string());
...
#[cfg(test)]
mod tests {
    use super::{basename, run_mcfly, strip_ext};
