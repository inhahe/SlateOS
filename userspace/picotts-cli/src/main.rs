...
//! picotts-cli — OurOS Pico TTS command-line interface
//!
...
fn run_picotts(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("picotts v1.0 (OurOS) — Pico TTS command-line interface");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("picotts v1.0 (OurOS)"); return 0; }
