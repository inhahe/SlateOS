...
fn run_wikijs(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("Wiki.js v2.5 (Slate OS) — Modern wiki engine");
        println!();
        println!("Commands:");
    ...
    if args.iter().any(|a| a == "--version") { println!("Wiki.js v2.5.303 (Slate OS)"); return 0; }
    println!("Wiki.js v2.5.303 (Slate OS)");
    println!("  Pages: 678");
    println!("  Users: 45");
    println!("  Groups: 8");
