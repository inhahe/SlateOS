...
fn run_anthy(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("anthy v0.4 (Slate OS) — Japanese kana-kanji conversion engine");
        println!();
        println!("Options:");
    ...
    if args.iter().any(|a| a == "--version") { println!("anthy v0.4 (Slate OS)"); return 0; }
...
fn run_dic_tool(args: &[String], _prog: &str) -> i32 {
    if args.iter().any(|a| a == "--help" || a == "-h") {
        ...
        println!("anthy-dic-tool v0.4 (Slate OS) — Anthy dictionary tool");
        return 0;
    }
    if args.iter().any(|a| a == "--version") { println!("anthy-dic-tool v0.4 (Slate OS)"); return 0; }
